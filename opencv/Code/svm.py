...
train_video_names = ["Sujeto1_R1_10kmh_20210715_175707", "Sujeto1_R2_12kmh_20210715_175812", "Sujeto2_R1_10kmh_20210715_180231", "Sujeto2_R2_12kmh_20210715_180326", 
               ...
               "Sujeto6_R2_12kmh_20210715_182300", "Sujeto7_R2_12kmh_20210715_182813", "Sujeto8_R1_10kmh_20210715_183143", "Sujeto8_R2_12kmh_20210715_183236",
               "Sujeto9_R1_10kmh_20210715_175119", "Sujeto9_R2_12kmh_20210715_175353"]
test_video_names = ["Sujeto3_R1_10kmh_20210715_180802", "Sujeto4_R2_12kmh_20210715_181312", "Sujeto7_R1_10kmh_20210715_182723"]
...
def print_results(X_train, X_test, Y_train, Y_test, sr_model, ctl_model, ctr_model, frl_model, frr_model) -> None:
    print("\n\nStep rate")
    print("\nTrain")
    print("R^2 =", sr_model.score(X_train, Y_train[["Step rate"]].values.ravel()))
    print("RMSE =", np.sqrt(mean_squared_error(Y_train[["Step rate"]].values.ravel(), sr_model.predict(X_train))))
    print("\nTest")
    print("R^2 =", sr_model.score(X_test, Y_test[["Step rate"]].values.ravel()))
    print("RMSE =", np.sqrt(mean_squared_error(Y_test[["Step rate"]].values.ravel(), sr_model.predict(X_test))))
...
def predict_videos(df, df_output, output_col, model):
    ...
    dropped_cols = ["Step rate", "Contact time L", "Contact time R", "Flight Ratio L", "Flight Ratio R", "Video"]
...
def main() -> None:
    ...
    output_cols = ["Step rate", "Contact time L", "Contact time R", "Flight Ratio L", "Flight Ratio R"]
    
    X_train, X_test, Y_train, Y_test = train_test(df_complete, output_cols)
    
    sr_model = train_svm(X_train, Y_train, "Step rate")
    ...
    print("\n\nTraining results:")
    print_results(X_train, X_test, Y_train, Y_test, sr_model, ctl_model, ctr_model, frl_model, frr_model)
    ...
    models = [sr_model, ctl_model, ctr_model, frl_model, frr_model]
